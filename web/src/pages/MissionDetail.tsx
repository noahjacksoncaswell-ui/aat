...
// v7.1.1 Section 3 - the four role-owned boxes + completion banner now
// live in a single shared component (LaunchStatusCheckBoard), used
// identically here and on Range Ops Display, so the two can never drift
// apart the way the pre-v7.1.1 Range Ops poll section did.
function PollsTab({ mission, missionId }: any) {
  return <LaunchStatusCheckBoard mission={mission} missionId={missionId} showHistory />;
}
